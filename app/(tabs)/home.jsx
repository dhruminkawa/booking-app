  ...
  return (
   <SafeAreaView style={[{backgroundColor:"#2b2b2b"}, Platform.OS==="android"&&{paddingBottom:40}]}>
    <View className='flex items-center '>
      <View className="bg-[#5f5f5f] w-11/12 rounded-lg shadow-lg justify-between items-center flex flex-row p-2 ">
        <View className="flex flex-row ">
          <Text className='text-base h-10 pt-[5 ] align-middle text-white'>Welcome to{" "}</Text>
    ...
    <ScrollView stickyHeaderIndices={[0]}>
       ...
       className='my-4 w-full h-52 bg-[#5f5f5f] items-center justify-center'
       source={banner}>
        <BlurView intensity={Platform.OS === "android" ? 100 : 55} tint='dark' className='w-full p-4 shadow-lg'>
   ...
   
    {
      ...
      horizontal contentContainerStyle={{padding:16}} 
