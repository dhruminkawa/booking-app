        ...
        <View className="flex-1">
            <View className={`flex ${selectedSlot != null && "flex-row"}`}>
                ...
                <View className="flex-1">
                    <TouchableOpacity onPress={handleBooking}>
                        <Text className="text-center text-white text-lg font-semibold bg-[#f49b33] p-2 my-3 mx-2 rounded-lg">Book Slots</Text>
                    </TouchableOpacity>
                </View>
                )}
            </View>
            ...
            {slotsVisible && (
                <View className="flex-wrap flex-row mx-2 p-2 bg-[#474747] rounded-lg">  
                    ...
                    (
                      <TouchableOpacity key={index} className={`m-2 p-4 bg-[#f49b33] rounded-lg items-center justify-center ${selectedSlot && selectedSlot !==slot ? "opacity-50":""}`}
